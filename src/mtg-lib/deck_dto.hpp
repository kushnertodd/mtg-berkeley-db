...
class Deck_DTO { // use Mtg_DTO as pattern but do not inherit
 public:
  ...
  Deck_DTO() = default;
//  Deck_DTO(const Deck_DTO &deck_dto) = default;
//  Deck_DTO(Deck_DTO &&deck_dto) = default;
//  Deck_DTO &operator=(const Deck_DTO &deck_dto) = default;
//  Deck_DTO &operator=(Deck_DTO &&deck_dto) = default;
