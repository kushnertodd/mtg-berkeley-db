...
std::map<std::string, int> Mtg_tokens::tripthongs_stoplist = {
    {"the", 1},
    {"ing", 1},
    {"ter", 1},
    {"man", 1},
...
bool Mtg_tokens::in_tripthongs_stoplist(const std::string &tripthong) {
  return Mtg_tokens::tripthongs_stoplist.find(tripthong) !=
      Mtg_tokens::tripthongs_stoplist.end();
}
 ...
 */
std::vector<std::string> Mtg_tokens::tripthongs(const std::string &str) {
